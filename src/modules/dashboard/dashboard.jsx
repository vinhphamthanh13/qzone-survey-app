...
class Dashboard extends PureComponent {
  ...
  render() {
    ...
    if (Object.is(listAssessments, null) || Object.is(listAssessments, undefined)) {
      chartDashBoard = <Loading isLoading />;
    } else if (listAssessments.length === 0) {
      chartDashBoard = <CustomInfo content="There is no Chart data of Assessment." />;
    } else {
      chartDashBoard = listAssessments.map((assessment, index) => (
        <ExpansionPanel
          key={assessment.id}
